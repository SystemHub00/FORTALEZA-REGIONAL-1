...
# =============================================================================
LOCAL_OPTIONS = [
    {"id": "1", "nome": "ASSOCIAÇÃO DOS MORADORES DO CONJUNTO POPULAR DA BARRA"},
    {"id": "2", "nome": "INSTITUTO DE CIDADANIA DO PIRAMBU"},
    {"id": "3", "nome": "INSTITUTO AGAPÊ"},
    {"id": "4", "nome": "ASSOCIAÇÃO COMUNITÁRIA DE AJUDA MUTUA DO PIRAMBU"},
]
...
# =============================================================================
COURSE_CATALOG = [
    {"id": "1", "nome": "26/DSBR 01 - DESIGNER DE SOBRANCELHAS"},
    {"id": "2", "nome": "26/MNCR 01 - MANICURE"},
...
# =============================================================================
ADDRESS_OPTIONS = {
    "1": "📍Rua Jacaúna, nº 691, bairro Barra do Ceará - CEP.: 60.332-530",
    "2": "📍Rua Santa Inês, nº 987, bairro Pirambu - CEP.: 60.311-310",
    "3": "📍Rua Pedro Sampaio, nº 453, bairro Vila Velha - CEP.: 60.346-285",
    "4": "📍Rua Santa Inês, nº 1247, bairro Pirambu - CEP.: 60.311-310",
}
...
<head>
    ...
    <title>Fortaleza - Regional I</title>
...
<body data-start-step="{{ current_step }}">
    ...
    <header class="main-header">
        <div class="header-logos">
            ...
            <img src="/static/logoprojeto.jpeg" alt="Fortaleza Regional I" class="logo-projeto-topo">
        </div>
    </header>
        ...
        <div class="wizard-shell">
            <form id="wizard-form" method="POST" action="{{ url_for('inscricao_unica') }}" autocomplete="off" novalidate>
                ...
                <section class="wizard-panel" data-step="index">
                    <div class="hero-grid">
                        <div class="hero-card">
                            <span class="hero-pill">FORTALEZA - REGIONAL I</span>
                            <p style="margin:10px 0 0; color:#8b0000; font-size:0.9rem; font-weight:700; line-height:1.5;">
                                Assoc. Moradores Conj. Popular da Barra | Instituto de Cidadania do Pirambu<br>
                                Instituto Agapê | Assoc. Comunitária de Ajuda Mutua do Pirambu
                            </p>
                            ...
                            <div class="hero-highlights">
                                ...
                                <div class="hero-highlight">
                                    <strong>FORTALEZA - REGIONAL I</strong>
...
def confirmacao():
    ...
    if not protocolo:
        return redirect(url_for("home"))
    home_url = "https://fortaleza-regional-1.onrender.com"
    return render_template_string(
        TEMPLATE_CONFIRMACAO,
        protocolo          = protocolo,
